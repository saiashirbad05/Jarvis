    ...
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh' }}>
      ...
      <main>
        ...
        <section style={{ padding: '6rem 1rem' }}>
          <div className="container" style={{ maxWidth: '1100px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            <div>
        ...
        <section style={{ padding: '6rem 1rem', backgroundColor: '#f8fafc' }}>
          <div className="container" style={{ maxWidth: '1100px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.15)', order: 2 }}>
          ...
          <div className="container" style={{ maxWidth: '1000px' }}>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '3rem', alignItems: 'center' }}>
                ...
                <div style={{ height: '300px', position: 'relative', paddingLeft: '2rem' }}>
                  {/* Simple SVG Graph */}
